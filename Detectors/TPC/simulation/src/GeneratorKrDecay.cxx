...
Bool_t GeneratorKrDecay::Init()
{
  ...
  std::cout << "[GeneratorKrDecay] Init:"
            << " rInner=" << o2::tpc::KrGenConfig::rInner
            << " rOuter=" << o2::tpc::KrGenConfig::rOuter
            << " halfZ=" << o2::tpc::KrGenConfig::halfZ
            << " nPerEvent=" << o2::tpc::KrGenConfig::nPerEvent << "\n";

  mTable = new o2::tpc::KrDecayTable();
...
Bool_t GeneratorKrDecay::generateEvent()
{
  ...
  const double rInner = o2::tpc::KrGenConfig::rInner + 1.0;
  const double rOuter = o2::tpc::KrGenConfig::rOuter - 1.0;
  const double halfZ = o2::tpc::KrGenConfig::halfZ - 1.0;
  const double r2Min = rInner * rInner;
  const double r2Max = rOuter * rOuter;
  for (int i = 0; i < o2::tpc::KrGenConfig::nPerEvent; ++i) {
...
Bool_t GeneratorKrDecay::importParticles()
{
  ...
  mParticles.reserve(o2::tpc::KrGenConfig::nPerEvent * o2::tpc::KrDecayTable::kNChannels);
